...
#### I'm a self-motivated developer proficient in C#, C-Programming, Bash Scripting, Python and I contribute to OSS. With a mission-driven attitude. I strongly believe that technology, when harnessed correctly, has the power to benefit both people and the planet. Let's Connect & Collaborate!
...
- 💬 Ask me about **Any topic in C-programming, C#, asp.net, Shell Scripting, SQL Server, Javascript, Python, Pentesting, Bootstrap, jQuery, Linux, etc.**
