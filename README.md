...
<h3 align="left">I'm a self-motivated developer proficient in C#, C-Programming, Bash Scripting, and Python. With a mission-driven nature, I strongly believe that technology, when harnessed correctly, has the power to benefit both people and the planet.</h3>
Passionate Dev | Open Source Enthusiast | Code Explorer | Problem Solver | Front-end & Back-end Web Dev | Contributing to OSS | Let's Connect & Collaborate!
...
- 💬 Ask me about **Any topic in C-programming, C#, Shell Scripting, SQL Server, Javascript, Python, Pentesting, Bootstrap, jQuery, Linux, etc.**
